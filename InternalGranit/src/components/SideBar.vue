...
=======
    ...
    <div class="h-screen text-white flex-1">
      ...
      <div class="sidebar__menu text-2xl">
        <ul>
          <RouterLink to="/">
            <li class="group sidebar__link hover:bg-white hover:cursor-pointer text-center px-7 py-7 text-xl">
              <a class="flex items-center" href="#">
                <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path class="group-hover:stroke-sidebar" fill-rule="evenodd" clip-rule="evenodd"
                    d="M7.98735 21.5V16.0093H14.0531V21.5H21V7.98364L10.8823 1.5L1 7.98364V21.5H7.98735Z" stroke="white"
            ...
            <li class="group sidebar__link hover:bg-white hover:cursor-pointer text-center px-7 py-7 text-xl">
              <a class="flex items-center" href="#">
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path class="group-hover:stroke-sidebar" d="M12.2441 17.0347V13.0347" stroke="#FFFF" stroke-width="2"
                    stroke-linecap="square" stroke-linejoin="round" />
                  <path class="group-hover:stroke-sidebar" d="M12.2401 9.23877H12.2501" stroke="#FFFF" stroke-width="2"
                    stroke-linecap="square" stroke-linejoin="round" />
                  <path class="group-hover:stroke-sidebar" fill-rule="evenodd" clip-rule="evenodd"
                    d="M21.5 22.2847V3.78467H3V22.2847H21.5Z" stroke="#FFFF" stroke-width="2" stroke-linecap="round" />
                </svg>
